...
export const MagicIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l-1.06-1.06a2 2 0 00-2.83 0L3 9.06a2 2 0 000 2.83L4.94 13l2.12-2.12L5 9l8-8zM17 5l2.12-2.12a2 2 0 000-2.83L18.06 1a2 2 0 00-2.83 0L14 2.06l2.12 2.12L17 5zm-3 14l-2.12 2.12a2 2 0 000 2.83L13 23a2 2 0 002.83 0l1.06-1.06-2.12-2.12zM19 13l-2.12 2.12 1.06 1.06a2 2 0 002.83 0l1.06-1.06a2 2 0 000-2.83L19 13z" />
  </svg>
);
...
export const ConditionalIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 2L2 12l10 10 10-10L12 2z"/>
    </svg>
);

// Fix: The `title` attribute is not a valid SVG prop in React. Use the <title> element for accessibility.
